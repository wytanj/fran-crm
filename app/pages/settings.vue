...
supabase/migrations/0006_fran_loyalty_analytics.sql
supabase/migrations/0007_agent_connectors_capabilities.sql</pre>
        </div>
        <p class="muted-text">The migrations include workspace membership, graph entities, relationships, custom field definitions, customer memory, profile packs, return eligibility, Fran loyalty analytics, agent connector installs, staff identity links, capability grants, integration accounts, billing records, proposals, approvals, execution logs, and audit events.</p>
      </article>
    </section>
  </div>
</template>
