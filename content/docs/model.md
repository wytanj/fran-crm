...
| `crm_mcp_request_logs` | MCP `tools/call` request ledger with method, tool, sanitized arguments, actor when known, relational workspace when safely attachable, final status, response summary, and error details. |
